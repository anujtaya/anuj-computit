...
<div class="border-top p-2">
   @if($session_draft_job != null)
      ...
      <div class="p-2 bg-white rounded fs--1 mb-3 shadow-sm mb-3" style="border-color:#f7f7f9!important;">
         ...
         <br>
         <a class="btn theme-background-color text-white btn-block btn-sm border-0 card-1 mt-2" href="{{route('guest_service_seeker_home')}}?showSPSView=on" onclick="toggle_animation(true)">Continue <i class="fas fa-arrow-right"></i></a>
      </div>
      @endif
   @endif

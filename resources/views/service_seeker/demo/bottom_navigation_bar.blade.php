   ...
   <div class="modal-dialog modal-dialog-centered-d" role="document">
      <div class="modal-content border-0 card-1">
         <div class="modal-body text-center" style="min-height:300px;">
            ...
            <a class="btn theme-background-color text-white" href="{{route('guest_register')}}?registration_type=sp" style="border-radius:30px;" onclick="toggle_animation(true);">Login or Signup</a>
         </div>
      </div>
   </div>
</div>

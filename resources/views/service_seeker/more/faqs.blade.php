...
<div class="container ">
   <div class="row  justify-content-center" >
      ...
      <div class="col-lg-12 fs--1 bg-white p-2 mt-2  border-d">
         <div  id="accordion">
            <div class="border mb-2 p-2 shadow-sm ">
               <div  class="" id="headingOne" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
            ...
            <div class="border mb-2 p-2 shadow-sm">
               <div class="  m-1   " id="headingTwo" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
            ...
            <div class="border mb-2 p-2 shadow-sm">
               <div class="  m-1   " id="heading3" data-toggle="collapse" data-target="#collapse3" aria-expanded="true" aria-controls="collapse3">
            ...
            <div class="border mb-2 p-2 shadow-sm">
               <div class="  m-1   " id="heading4" data-toggle="collapse" data-target="#collapse4" aria-expanded="true" aria-controls="collapse4">
            ...
            <div class="border mb-2 p-2 shadow-sm">
               <div class="  m-1   " id="heading9" data-toggle="collapse" data-target="#collapse9" aria-expanded="true" aria-controls="collapse9">
            ...
            <div class="border mb-2 p-2 shadow-sm">
               <div class="  m-1   " id="heading5" data-toggle="collapse" data-target="#collapse5" aria-expanded="true" aria-controls="collapse5">
            ...
            <div class="border mb-2 p-2 shadow-sm">
               <div class="  m-1   " id="heading7" data-toggle="collapse" data-target="#collapse7" aria-expanded="true" aria-controls="collapse7">
            ...
            <div class="border mb-2 p-2 shadow-sm">
               <div id="heading8" data-toggle="collapse" data-target="#collapse8" aria-expanded="true" aria-controls="collapse8">
            ...
            <div class="border mb-2 p-2 shadow-sm">
               <div class="  m-1   " id="heading10" data-toggle="collapse" data-target="#collapse10" aria-expanded="true" aria-controls="collapse10">
            ...
            <div class="border mb-2 p-2 shadow-sm">
               <div class="  m-1   " id="heading6" data-toggle="collapse" data-target="#collapse6" aria-expanded="true" aria-controls="collapse6">
            ...
            <div class="border mb-2 p-2 shadow-sm">
               <div class="  m-1   " id="heading11" data-toggle="collapse" data-target="#collapse11" aria-expanded="true" aria-controls="collapse11">

         ...
         <div class="row m-0 text-center fs--1">
            <div class="col-6 p-0">
               <div class="border m-2  h-100 rounded  p-3">
                  <a href="{{route('service_seeker_more_help')}}" onclick="toggle_animation(true);" class="theme-color text-decoration-none"><img src="{{asset('/images/service_seeker/help.svg')}}" height="100px" width="100px" alt=""> <br>
                  Help
                  </a>  
               </div>
            </div>

...
<div class="wrapper">
   ...
   <div id="over_map_bottom" class="text-center">
      ...
      <a class="btn btn-block btn-sm  card-1 mt-2" style="border-radius:20px;background:#5D29BA!important;color:white!important;" href="{{route('service_provider_home')}}" onclick="toggle_animation(true);">Switch to Provider - I want to work</a>
   </div>
   <div id="over_map_top" >
      @if(count($jobs) > 0)

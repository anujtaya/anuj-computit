<div class="fs--1 mt-2 p-2 " id="scroll-area" style="overflow:scroll; height:500px;scroll-behavior: smooth;">
   ...
   <div class="media w-100 ml-auto  mb-3">
    ...
    <div class="media w-50   mb-3">
         <div class="media-body ml-2">
            <div class=" text-white  py-2 px-3 mb-2 rounded" style="background:#5D29BA!important;color:white!important;">
               <span class="text-small">Job Description:</span>
               <p class="text-small text-white mb-0 "><i>{{$job->description}}</i></p>
            </div>

...
<div class="fs--1">
   ...
   <div>
      ...
      <div class="d-flex bd-highlight mb-2 card-1 rounded">
         <div class="p-2 bd-highlight">  
            <img  src="https://s3-ap-southeast-2.amazonaws.com/l2l-resources/{{$conversation_current->service_provider_information->profile_image_path}}"  
                  ...
                  class="border p-1"  height="45" width="45" style="border-radius:50%;" alt="Service Seeker Profile Image 40*40">
         </div>
         <div class="pl-2 pr-2 pt-3 fs--1 bd-highlight">   
              {{$conversation_current->service_provider_information->first}} is on the way to the job location. Track your Service Provider using the Google map below.
          </div>
      </div>
      <!-- live tracking stats  -->
      <div class="mb-2">
         <!-- <div class="p-0 bd-highlight">
            <span class="badge border-0 text-danger fs--1 card-1"><i class="fas fa-circle animated infinite fadeIn fs--2 "></i> Live</span>
         </div> -->
         <div class="" onclick="find_eta();">
            <div class="badge theme-color fs--1 card-1 text-left d-block" id="service_provider_eta">----</div>
         </div>
      </div>
      <!-- map div -->
...
<script>
   ...
   function send_proximity_alert_to_seeker() {
      ...
      $.ajax({
            type: "POST",
            url: "{{route('service_seeker_job_notify_arrival')}}",
            data: {
               "_token": CSRF_TOKEN,

...
<div class="fs--1">
   <div class="p-2">
      ...
      <br>
      <form class="fs--1" action="" method="get" class="m-0">
         @csrf
         <div class="radio">
            <input id="radio-1" name="demo_type" type="radio" value="STRIPE" checked="">
            <label for="radio-1" class="radio-label  fs--1" >Credit/Debit Card</label>
         </div>
         <div class="radio">
            <input id="radio-2" name="demo_type" value="PAYPAL" type="radio" disabled>
            <label for="radio-2" class="radio-label">Paypal</label>
         </div>
         <div class="radio">
            <input id="radio-2" name="demo_type" value="ZIPPAY" type="radio" disabled>
            <label for="radio-2" class="radio-label">ZipPay</label>
         </div>
         <div class="mt-4">
            <button class="btn btn-lg btn-warning btn-block shadow text-white" onclick='alert("Test Button");'>Pay <small>$</small>{{number_format($job_payment->job_price, 2)}}</button>                  
         </div>
      </form>
      @else

   ...
   <div class="row mt-4s justify-content-center">
      <div class="col-md-4 borders">
         <div class="card shadow-none p-1 text-center">
            ...
            <a class="btn btn-info rounded-3 borders custom_button_shadow ml-4 mr-4 mt-4 font-weight-normal"  href="{{route('login')}}" onclick="toggle_animation(true);">Let's Get Started <i class="ml-2 fas fa-arrow-right"></i></a>

                    ...
                    @csrf
                     <div class="form-group mt-3 row">
                        ...
                        <div class="col-md-12 text-centerw mb-0">
                           ...
                           <button type="submit" class="btn  btn-success fs--1 text-white  font-weight-normal mt-2" width="221px" height="47px" id="" onclick='main_btn_status(this.id);$("#login_form").submit();'>
                           {{ __('Continue') }}
                           </button>

           ...
           <div class="wrapper">
              <canvas id="chart-area-monthly"></canvas>
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                                <button class="btn theme-background-color btn-sm" onclick="chart_fetch_monthly(document.getElementById('start_date_input').value, document.getElementById('end_date_input').value);">Update Chart</button>
                            </div>
                     </div>

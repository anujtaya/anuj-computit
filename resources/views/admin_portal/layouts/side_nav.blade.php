<nav class="navbar navbar-vertical navbar-expand-xl custom-light-background navbar-glass">
   <a class="navbar-brand text-left p-2" href="{{route('app_portal_provider_home')}}">
     <img src="{{asset('/images/brand/l2l-logo-svg.svg')}}" height="40" width="40" alt="LocaL2LocaL Brand Logo" class="rounded-circle p-1">
     <div class="fs-1 mt-2 text-secondary">Admin Portal</div>
   ...
   <div class="collapse navbar-collapse p-2" id="navbarVerticalCollapse">
      <ul class="navbar-nav flex-column mt-2">
         <li class="nav-item">
            <a class="nav-link {{ (request()->is('app/portal/admin/home')) ? 'text-dark' : '' }}" href="{{route('app_portal_admin_home')}}"  >
         ...
         <li class="nav-item">
            <a class="nav-link {{ (request()->is('app/portal/admin/users/all')) ? 'text-dark' : '' }}" href="{{route('app_portal_admin_users_all')}}"  >
               <div class="d-flex align-items-center">
                  <span class="nav-link-icon">

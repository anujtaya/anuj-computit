   ...
   <div class="row  justify-content-center" >
      <div class="col-lg-12 shadow-sm sticky-top bg-white p-3 border-d">
         <div class="row">
            ...
            <div class="col-8 font-size-bolder text-center font-weight-bold theme-color">{{$service_seeker_profile->first}} {{$service_seeker_profile->last}}  <br><span class="fs--2 text-muted font-weight-normal"> Message history</span> </div>

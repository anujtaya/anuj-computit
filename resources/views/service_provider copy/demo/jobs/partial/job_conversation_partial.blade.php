<div class="fs--1 mt-2 p-2 " id="scroll-area" style="overflow:scroll; height:500px;scroll-behavior: smooth;">
   ...
   <div class="alert alert-warning">
      Messages won't appear unless a Seeker is trying to make in contact with you.
      Please wait for a notification to appear for this function to be enabled.
   </div>
   @endif
</div>

      ...
      <div class="row m-0">
         <div class="col-8 pl-2 pt-3 pb-3">
            ...
            <a class="btn theme-color  shadow-sm border-0 fs--1 bg-white text-muted" style="border-radius:20px;"
               id="list_btn" href="{{route('service_provider_home')}}?listview=true">
      ...
      <div class="row m-0  border-bottom">
         ...
         <div class="col-12 p-0 border-bottom bg-white">
            <div class="d-flex fs--2 bd-highlight">
               <div class="p-2 bd-highlight" onclick="handle_automatc_loc_update_failure();"
         ...
         <div class="col-12 fs--2 pt-2 pb-2 pr-2 text-right text-muted bg-white">
            ...
            <button class="btn btn-sm  theme-background-color border-0 fs--2 shadow"
               onclick="set_display_bounds();filter_service_provider_jobs(current_filter_choice,false);"
               id="map_reset_btn">
...
<script>
   ...
   window.onload = function() {
      ...
      update_interval = setInterval(function(){ filter_service_provider_jobs(current_filter_choice,false), counter() }, 20000);

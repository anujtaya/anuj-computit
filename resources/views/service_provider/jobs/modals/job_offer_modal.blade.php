  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="input-group mb-3">
        ...
        <input type="number" id="job_offer" name="job_offer" value=""  min="1" max="1000" step="0.01" class="form-control" style="border-top-right-radius: 10px!important; border-bottom-right-radius: 10px!important;" aria-label="job_offer" aria-describedby="basic-addon1" required>
      </div>

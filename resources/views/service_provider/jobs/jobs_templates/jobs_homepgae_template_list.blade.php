<!-- board job types -->
@foreach($jobs as $job)
<li class="list-group-item mb-2  fs--2 border p-0"  style="cursor:pointer;" onclick="location.href= app_url + '/service_provider/jobs/job/{{$job->id}}';toggle_animation(true);">  

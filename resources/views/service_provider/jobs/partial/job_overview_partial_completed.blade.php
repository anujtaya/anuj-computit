...
<div class="fs--1">
   <div class="p-2">
      ...
      <div class="d-flex border bd-highlight" style="border-style:dotted!important;">
         <div class="p-2 bd-highlight">L2L Service Fee ({{number_format($job->job_payment->service_fee_percentage, 2)}})</div>
         <div class="ml-auto p-2 bd-highlight text-danger"> ${{number_format($job->job_payment->service_fee_price, 2)}}</div>
      </div>
      <div class="d-flex border bd-highlight" style="border-style:dotted!important;">
         <div class="p-2 bd-highlight">You Get</div>
         <div class="ml-auto p-2 bd-highlight text-success"> ${{number_format($job->job_payment->job_price - $job->job_payment->service_fee_price, 2)}}</div>
      </div>
      <div class="d-flex border bd-highlight" style="border-style:dotted!important;">

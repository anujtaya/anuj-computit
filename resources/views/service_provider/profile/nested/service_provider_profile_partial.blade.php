<div class="mt-2 fs--1">
   ...
   <div class="d-flex  theme-background-color rounded  text-white bd-highlight m-2 sticky-top shadow">
      ...
      <div class="p-3 ml-auto bd-highlight">
         <a href="{{route('service_provider_profile_edit')}}" onclick="toggle_animation(true);" class="float-right text-white">Edit Info</a>
      </div>
   </div>

...
<div class="mt-2 fs--1">
   ...
   <div class="m-2 rounded card-1">
      ...
      <div>
         @foreach($stats->rating_records->take(2) as $r)
      ...
      <div class="d-flex flex-row-reverse bd-highlight">
         <div class="p-2 bd-highlight">
            <a href="{{route('service_provider_profile_nested_reviews')}}" class="btn theme-background-color btn-sm card-1" onclick="toggle_animation(true);">More <i class="fas fa-arrow-right"></i> </a>
         </div>
      </div>
   </div>
</div>

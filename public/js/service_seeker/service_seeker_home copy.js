...
var current_address_pickup_string = {
    street_number: '',
    street_name: '',
    state: '',
    postcode: '',
...
var current_address_dropoff_string = {
    street_number: '',
    street_name: '',
    state: '',
    postcode: '',
...
map_dropoff = new google.maps.Map(document.getElementById('map_pickup'), {
...
function wizard_switch_6(id) {
    ...
    if (!a) {
        ...
        setTimeout(function() { $("#location_pickup").removeClass('animated shake '); }, 1000);
    } else {
...
function prepare_user_address_pickup_object(address_object) {
    ...
    for (var i = 0; i < address_object.length; i++) {
        ...
        var val = address_object[i]['long_name']
        if (address_type == "street_number") {
            current_address_pickup_string.street_number = val;
        } else if (address_type == "route") {
            current_address_pickup_string.street_name = val;
        } else if (address_type == "administrative_area_level_2") {
            current_address_pickup_string.city = val;
        } else if (address_type == "administrative_area_level_1") {
            current_address_pickup_string.state = val;
        } else if (address_type == "postal_code") {
            current_address_pickup_string.postcode = val;
        } else if (address_type == "postal_code") {
            current_address_pickup_string.postcode = val;
        } else if (address_type == "locality") {
            current_address_pickup_string.suburb = val;
        }
    }
}
...
function prepare_user_address_dropoff_object(address_object) {
    //make default values null
    current_address_dropoff_string = {
        street_number: '',
        street_name: '',
        state: '',
        postcode: '',
    ...
    for (var i = 0; i < address_object.length; i++) {
        ...
        var val = address_object[i]['long_name']
        if (address_type == "street_number") {
            current_address_dropoff_string.street_number = val;
        } else if (address_type == "route") {
            current_address_dropoff_string.street_name = val;
        } else if (address_type == "administrative_area_level_2") {
            current_address_dropoff_string.city = val;
        } else if (address_type == "administrative_area_level_1") {
            current_address_dropoff_string.state = val;
        } else if (address_type == "postal_code") {
            current_address_dropoff_string.postcode = val;
        } else if (address_type == "postal_code") {
            current_address_dropoff_string.postcode = val;
        } else if (address_type == "locality") {
            current_address_dropoff_string.suburb = val;
        }
    }
}